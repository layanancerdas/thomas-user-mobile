                        ...
                        children: [
                          ...
                          state.selectedMyTrip['status'] == "PENDING" ||
                                  (state.selectedMyTrip['status'] ==
                                          "CANCELED" &&
                                      state.selectedMyTrip['booking_details'] ==
                                          null)
                              ? CardWaitingPayment()
                              : CardBooking(
                                  completed: state.selectedMyTrip['status'] ==
                                          "COMPLETED" ||
                                      state.selectedMyTrip['status'] ==
                                          "MISSED" ||
                                  ...
                                  bookingCode:
                                      state.selectedMyTrip['booking_code'],
                                  bookingId: state.selectedMyTrip['booking_id'],
                                  addressA: state.selectedMyTrip['pickup_point']
                                          ['address'] ??
                                      "-",
                                  ...
                                  dateA: state.selectedMyTrip['trip']['type'] ==
                                          'RETURN'
                                  ...
                                  pointA: state.selectedMyTrip['pickup_point']
                                      ['name'],
                                  pointB: state.selectedMyTrip['trip']
                                          ['trip_group']['route']
                                      ['destination_name'],
                                  timeB: state.selectedMyTrip['trip']['type'] ==
                                          'RETURN'
                                  ...
                                  timeA: state.selectedMyTrip['trip']['type'] ==
                                          'RETURN'
                                      ? Utils.formatterTime.format(DateTime.parse(
                                          state.selectedMyTrip['trip']
                                              ...
                                              state.selectedMyTrip['trip']['trip_group']
                                                  ['return_time']))
                                      : Utils.formatterTime.format(DateTime.parse(
                                          state.selectedMyTrip['trip']['trip_group']['start_date'] + " " + state.selectedMyTrip['trip']['trip_group']['departure_time'])),
                                ),
                          state.selectedMyTrip['status'] != "PENDING" ||
                                  (state.selectedMyTrip['status'] !=
                                          "CANCELED" &&
                                      state.selectedMyTrip['invoice'] != null)
                              ? Column(
                          ...
                          state.selectedMyTrip['status'] == "PENDING" ||
                                  (state.selectedMyTrip['status'] == "ACTIVE" &&
                                      ...
                                      state.selectedMyTrip['details']
                                          ...
                                          'ONGOING')
                              ? SizedBox()
                              : state.selectedMyTrip['status'] == "COMPLETED" &&
                                      state.selectedMyTrip['rating'] == null &&
